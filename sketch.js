...
function setup() {
  ...
  // Add Spells
  Accio = createSprite(200, 100); // Set the position of Accio sprite
  Accio.addImage("accio", AccioImg);
  Accio.scale = 0.3;
...
function createAccio() {
  ...
  var Accio = createSprite(Math.round(random(50,350),40, 10, 10));
